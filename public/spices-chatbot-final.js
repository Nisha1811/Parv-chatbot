(function(){
  ...
  function sendMessage(){
    ...
    fetch(hook,{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({chatInput:text,message:text,text:text,sessionId:'parv_'+Date.now(),botName:botName})}).then(function(r){return r.text();}).then(function(reply){
      typingRow.remove();
